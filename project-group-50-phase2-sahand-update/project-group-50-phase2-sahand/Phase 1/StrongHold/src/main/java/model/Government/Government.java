...
public class Government implements Serializable {
    ...
    public void feedPeople() {
        ...
        double cheeseDecrease = this.getPopulation() * value * ((double)this.resources.get(Resource.CHEESE) / this.getFoodNumber());
        double meatDecrease = this.getPopulation() * value * ((double)this.resources.get(Resource.MEAT) / this.getFoodNumber());
        double appleDecrease = this.getPopulation() * value * ((double)this.resources.get(Resource.APPLE) / this.getFoodNumber());
        double breadDecrease = this.getPopulation() * value * ((double)this.resources.get(Resource.BREAD) / this.getFoodNumber());
