...
public class RandomCaptcha {
    ...
    private static ArrayList<Integer> numberCaptcha=new ArrayList<> ( Arrays.asList ( 1181,1381,1491,1722,1959,2163,2177,2723,2785,3541,3847,3855,3876,3967,4185,4310,4487,
    ...
    public static void readAllFile(){
        ...
        for ( File fileEntry : Objects.requireNonNull ( folder.listFiles () ) ) {
            if ( Pattern.compile ( "\\d+\\.png" ).matcher ( fileEntry.getName ()).find ()) {
                RandomCaptcha.numberCaptcha.add ( Integer.valueOf ( fileEntry.getName ().substring ( 0,fileEntry.getName ().length ()-4 ) ) );
            }
        }
    }
