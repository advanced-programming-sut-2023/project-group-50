...
public class LoginMenuShowController {
    ...
    public void login(){
        ...
        }else if (! ((TextField)((HBox)this.captcha.getChildren ().get ( 0 )).getChildren ().get ( 1 )).getText ().trim ().equals ( String.valueOf ( captchaNumber ) ) )
        {
            ...
            ((Rectangle)((HBox)this.captcha.getChildren ().get ( 0 )).getChildren ().get ( 0 )).setFill (  new ImagePattern (new Image (RandomCaptcha.class.getResource ( "/Captcha/"+captchaNumber+".png").toExternalForm ())));
