...
public class ShopMenuController {
    ...
    public Error sell(String name) {
        ...
        if(currentUser.getGovernment ().getResourceAmount ( Resource.getResourceByString ( name ) )<item.getCount ()) return  new Error ( "You don't have enough of this item",false );
