...
public class SignupMenuShowController {
    ...
    public static void addError(HBox hBox, Error error) {
        if (!error.truth) {
            hBox.getChildren().get(0).setOpacity(1);
        } else {
            hBox.getChildren().get(0).setOpacity(0);
        }
    ...
    public static VBox createCaptcha() {
        ...
        captchaImage.setFill(new ImagePattern(new Image(RandomCaptcha.class.getResource(
    ...
    private void submit() {
        ...
        this.user = SignupController.createUser(((TextField) ((HBox) username.getChildren().get(0)).getChildren().get(1)).getText().trim(),
                                                ...
                                                slogan,
                                                RandomGenerator.randomFrom(UserColor.values())
    ...
    public void checkQuestion() {
        ...
        if (((TextField) ((HBox) ((VBox) this.question.getChildren().get(1)).getChildren().get(0)).getChildren().get(1)).getText().trim().equals("")) {
            ...
            captchaNumber = RandomCaptcha.getCaptcha();
            ((Rectangle) ((HBox) ((VBox) this.question.getChildren().get(1)).getChildren().get(0)).getChildren().get(0)).setFill(new ImagePattern(new Image(RandomCaptcha.class.getResource(
                    "/Captcha/" + captchaNumber + ".png").toExternalForm())));
