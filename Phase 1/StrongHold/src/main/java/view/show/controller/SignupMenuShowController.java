...
public class SignupMenuShowController {
    ...
    public Parent createContent(){
        ...
        VBox menu=new VBox (creatUsernameField (),creatPasswordField (),createEmail (),createNickname (),createSlogan (),createButtons ());
    ...
    private Node creatUsernameField(){
        ...
        hBox.getChildren ().addAll ( userImage,username,createReset ( "username" ) );
    ...
    private static TextField getTextField (String input) {
    ...
    private ImageView getImage (String normal , String color , TextField text) {
    ...
    private void addError(HBox hBox, Error error){
        if(!error.truth ) {
    ...
    private Node creatPasswordField(){
        ...
        hBox.getChildren ().addAll (  passwordImage,password,eyeImage,createReset ( "password" ) );
        hBox.setAlignment ( Pos.CENTER );
        hBox.setSpacing ( 7 );
        VBox vBox=new VBox (hBox);
        vBox.setAlignment ( Pos.CENTER );
        ...
        vBox.getChildren ().addAll ( createRandom ( "password" ),errorBox );
        this.password=vBox;
        return vBox;

    }

    private void passwordToShow (HBox hBox,PasswordField passwordField) {
    ...
    private Node createEmail(){
        ...
        hBox.getChildren ().addAll ( emailImage ,email,createReset ( "email" ) );
        hBox.setAlignment ( Pos.CENTER );
        hBox.setSpacing ( 7 );
        VBox vBox=new VBox (hBox);
        vBox.setAlignment ( Pos.CENTER );
    ...
    private static ImageView getErrorImage () {
    ...
    private Node createNickname(){
        ...
        hBox.getChildren ().addAll ( nickImage , nick,createReset ( "nickname" ) );
        hBox.setAlignment ( Pos.CENTER );
        hBox.setSpacing ( 7 );
        VBox vBox=new VBox (hBox);
        vBox.setAlignment ( Pos.CENTER );
    ...
    private Node createSlogan(){
        ...
        hBox.getChildren ().addAll ( sloganImage , slogan ,createReset ( "slogan" ) );
        hBox.setAlignment ( Pos.CENTER );
        hBox.setSpacing ( 7 );
        VBox vBox=new VBox ();
        vBox.setAlignment ( Pos.CENTER );
        ...
        showSlogan.setOnMouseClicked ( new EventHandler<MouseEvent> () {
            ...
            public void handle (MouseEvent event) {
                if(vBox.getChildren ().size ()==4){
                    ...
                    vBox.getChildren ().add ( 0,createRandom ( "slogan" ) );
    ...
    private Node createRandom(String random){
        HBox hBox=new HBox ();
        ...
        use.setOnMouseClicked ( new EventHandler<MouseEvent> () {
            ...
            public void handle (MouseEvent event) {
                if(random.equals ( "password" )){
                    ((PasswordField)((HBox)password.getChildren ().get ( 0 )).getChildren ().get ( 1 )).setText ( text.getText ().substring ( 26 ) );
                }else {
                    ((TextField)((HBox)slogan.getChildren ().get ( 0 )).getChildren ().get ( 1 )).setText ( text.getText ().substring ( 17 ) );
                }
                text.setText ( "" );
    ...
    private  Node createReset(String part){
        ...
        image.setOnMouseClicked ( new EventHandler<MouseEvent> () {
            ...
            public void handle (MouseEvent event) {
                ...
                if(part.equals ( "username" )){
                    ((TextField)((HBox)username.getChildren ().get ( 0 )).getChildren ().get ( 1 )).setText ( "" );
                }else if ( part.equals ( "password" ) ){
                    ((PasswordField)((HBox)password.getChildren ().get ( 0 )).getChildren ().get ( 1 )).setText ( "" );
                }else if(part.equals ( "email" )){
                    ((TextField)((HBox)email.getChildren ().get ( 0 )).getChildren ().get ( 1 )).setText ( "" );
                }else if(part.equals ( "nickname" )){
                    ((TextField)((HBox)nickname.getChildren ().get ( 0 )).getChildren ().get ( 1 )).setText ( "" );
                }else if(part.equals ( "slogan" )){
                    ((TextField)((HBox)slogan.getChildren ().get ( 0 )).getChildren ().get ( 1 )).setText ( "" );
                }
    ...
    private void createPickQuestion(){
        ...
        TextField captcha = getTextField ("");
        Rectangle captchaImage =new Rectangle (100,50);
        this.captchaNumber=RandomCaptcha.getCaptcha ();
        captchaImage.setFill (  new ImagePattern (new Image (RandomCaptcha.class.getResource ( "/Captcha/"+this.captchaNumber+".png").toExternalForm ())));

        hBox.getChildren ().addAll ( captchaImage , captcha  );
        hBox.setAlignment ( Pos.CENTER );
        hBox.setSpacing ( 7 );
        VBox vBox=new VBox (hBox);
        vBox.setAlignment ( Pos.CENTER );
        ...
        vBox.getChildren ().addAll ( tryAgain,errorBox,button );
    ...
    public void checkQuestion(){
        ...
        if(((TextField)((HBox)this.question.getChildren ().get ( 0 )).getChildren ().get ( 1 )).getText ().equals ( "" )){
            error=new Error ( "You should enter captcha",false);
            flag=false;
        }else if (! ((TextField)((HBox)this.question.getChildren ().get ( 0 )).getChildren ().get ( 1 )).getText ().equals ( String.valueOf ( this.captchaNumber ) ) )
        {
            error=new Error ( "Your captcha is wrong try again",false );
            captchaNumber=RandomCaptcha.getCaptcha ();
            ( (Rectangle)((HBox) this.question.getChildren ().get ( 0 )).getChildren ().get ( 0 )).setFill (  new ImagePattern (new Image (RandomCaptcha.class.getResource ( "/Captcha/"+captchaNumber+".png").toExternalForm ())));
            flag=false;

        }
        addError ( ((HBox)this.question.getChildren ().get ( 2 )),error );
